    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(80,155,168,0.20) 0%, rgba(80,155,168,0.08) 45%, transparent 75%)',
          borderRadius: '50%',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(112,141,168,0.17) 0%, rgba(112,141,168,0.07) 45%, transparent 75%)',
          borderRadius: '50%',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(80,155,168,0.14) 0%, rgba(80,155,168,0.05) 50%, transparent 80%)',
          borderRadius: '50%',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(112,141,168,0.20) 0%, rgba(112,141,168,0.08) 45%, transparent 75%)',
          borderRadius: '50%',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(80,155,168,0.16) 0%, rgba(80,155,168,0.06) 45%, transparent 75%)',
          borderRadius: '50%',
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(204,130,88,0.13) 0%, rgba(204,130,88,0.04) 50%, transparent 80%)',
          borderRadius: '50%',
      ...
      >
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, transparent, rgba(80,155,168,0.35) 20%, rgba(80,155,168,0.35) 80%, transparent)',
        }} />
        {/* Dot 1 — travels down */}
        <div style={{
          ...
          background: '#509ba8',
          boxShadow: '0 0 10px rgba(80,155,168,0.9), 0 0 22px rgba(80,155,168,0.35)',
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, transparent, rgba(112,141,168,0.25) 25%, rgba(112,141,168,0.25) 75%, transparent)',
        }} />
        ...
        <div style={{
          ...
          background: '#708da8',
          boxShadow: '0 0 8px rgba(112,141,168,0.85)',
      ...
      >
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, transparent, rgba(80,155,168,0.28) 20%, rgba(80,155,168,0.28) 80%, transparent)',
        }} />
        {/* Dot 1 — travels up */}
        <div style={{
          ...
          width: 8, height: 8, borderRadius: '50%',
          background: '#509ba8',
          boxShadow: '0 0 10px rgba(80,155,168,0.85)',
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, transparent, rgba(112,141,168,0.20) 25%, rgba(112,141,168,0.20) 75%, transparent)',
        }} />
        ...
        <div style={{
          ...
          width: 5, height: 5, borderRadius: '50%',
          background: '#708da8',
          boxShadow: '0 0 7px rgba(112,141,168,0.75)',
